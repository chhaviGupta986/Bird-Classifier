...
def prediction(audio_file):
    ...
    bird_species=['Common Ostrich', 'Somali Ostrich', 'Greater Rhea', 'Lesser Rhea', 'Southern Brown Kiwi', 'North Island Brown Kiwi', 'Okarito Kiwi', 'Little Spotted Kiwi', 'Great Spotted Kiwi', 'Southern Cassowary', 'Dwarf Cassowary', 'Northern Cassowary', 'Emu', 'Grey Tinamou', 'Solitary Tinamou', 'Black Tinamou', 'Great Tinamou', 'White-throated Tinamou', 'Highland Tinamou', 'Tawny-breasted Tinamou', 'Hooded Tinamou', "Berlepsch's Tinamou", 'Cinereous Tinamou', 'Little Tinamou', 'Tepui Tinamou', 'Brown Tinamou', 'Undulated Tinamou', 'Pale-browed Tinamou', 'Brazilian Tinamou', 'Grey-legged Tinamou', 'Red-legged Tinamou', 'Yellow-legged Tinamou', 'Black-capped Tinamou', 'Thicket Tinamou', 'Slaty-breasted Tinamou', 'Choco Tinamou', 'Variegated Tinamou', 'Rusty Tinamou', "Bartlett's Tinamou", 'Small-billed Tinamou', 'Barred Tinamou', 'Tataupa Tinamou', 'Red-winged Tinamou', 'Huayco Tinamou', "Taczanowski's Tinamou", 'Ornate Tinamou', 'Chilean Tinamou', 'Brushland Tinamou', 'Andean Tinamou', 'Curve-billed Tinamou', 'White-bellied Nothura', 'Lesser Nothura', 
"Darwin's Nothura", 'Spotted Nothura', 'Dwarf Tinamou', 'Elegant Crested Tinamou', 'Quebracho Crested Tinamou', 'Puna Tinamou', 'Patagonian Tinamou', 'Australian Brushturkey', 'Wattled Brushturkey', 'Red-billed Brushturkey', 'Black-billed Brushturkey', 'Collared Brushturkey', 'Malleefowl', 'Maleo', 'Moluccan Megapode', 
'Tongan Megapode', 'Micronesian Megapode', 'Nicobar Megapode', 'Philippine Megapode', 'Sula Megapode', 'Tanimbar Megapode', 'Dusky Megapode', 'Biak Scrubfowl', 'Melanesian Megapode', 'Vanuatu Megapode', 'New Guinea Scrubfowl', 'Orange-footed Scrubfowl', 'Plain Chachalaca', 'Grey-headed Chachalaca', 'Chestnut-winged Chachalaca', 'Rufous-vented Chachalaca', 'Rufous-headed Chachalaca', 'Rufous-bellied Chachalaca', 'West Mexican Chachalaca', 'Chaco Chachalaca', 'White-bellied Chachalaca', 'Speckled Chachalaca', 'East Brazilian Chachalaca', 'Scaled Chachalaca', 'Colombian Chachalaca', 'Little Chachalaca', 'Chestnut-headed Chachalaca', 'Buff-browed Chachalaca', 'Band-tailed Guan', 'Bearded Guan', 'Baudo Guan', 'Andean Guan', 'Marail Guan', 'Rusty-margined Guan', 'Red-faced Guan', 'Crested Guan', 'Cauca Guan', 'White-winged Guan', "Spix's Guan", 'Dusky-legged Guan', 'White-crested Guan', 'Chestnut-bellied Guan', 'White-browed Guan', 'Trinidad Piping Guan', 'Blue-throated Piping Guan', 'Red-throated Piping Guan', 'Black-fronted Piping Guan']
    add_vertical_space(1)
